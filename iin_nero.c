                 ...
                 /*@out@*/ u_int32_t *footer_length)
{
    ...
    if (result == OSAL_OK) { /* read header (located 156 bytes before end-of-file during my tests :-) ) */
        u_int32_t len;
                 ...
                 /*@out@*/ u_int32_t *footer_length)
{
    ...
    if (result == OSAL_OK) { /* read header (located 72 bytes before end-of-file during my tests :-) ) */
        u_int32_t len;
            ...
            *iin = (iin_t *)img_base;
            switch (mode) {
                case ndm_mode1_plain:
                    strcpy((*iin)->source_type, "Nero Image, Mode 1, plain");
                    break;
                case ndm_mode1_raw:
                    strcpy((*iin)->source_type, "Nero Image, Mode 1, RAW");
                    break;
                case ndm_mode2_plain:
                    strcpy((*iin)->source_type, "Nero Image, Mode 2, plain");
                    break;
                case ndm_mode2_raw:
                    strcpy((*iin)->source_type, "Nero Image, Mode 2, RAW");
                    break;
            }
